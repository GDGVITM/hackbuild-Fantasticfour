...
export default function MockInterviewPage() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      type: "bot",
      content:
        "Hello! I'm your AI Interview Coach. I'll help you practice for your upcoming interviews. Let's start with a simple question: Tell me about yourself",
      timestamp: new Date(),
    },
  ]);
  ...
  const [previousResponse, setPreviousResponse] =
    useState<mockInterviewResponse>({
  ...
  const [interviewType, setInterviewType] = useState(
    "Software engineering interview for a tech company position."
  );
  ...
  const handleSendMessage = useCallback(
    async (messageOverride?: string) => {
      ...
      try {
        ...
        // Convert to AIResponse format for UI, include feedback
  ...
  const clearChat = () => {
    const initialMessage =
      "Hello! I'm your AI Interview Coach. I'll help you practice for your upcoming interviews. Let's start with a simple question: Tell me about yourself and why you're interested in this position.";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#edf6f9] via-[#edf6f9] to-[#ffddd2]/20 relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-tr from-[#ffddd2]/20 to-[#e29578]/10 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-[#83c5be]/5 to-[#006d77]/5 rounded-full blur-3xl animate-pulse"
          ...
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-4">
              ...
              >
                ...
                <span className="text-lg sm:text-xl md:text-2xl font-bold bg-gradient-to-r from-[#006d77] to-[#83c5be] bg-clip-text text-transparent">
                  EduMitra
                </span>
              </Link>
              ...
              <div className="flex items-center space-x-2">
                ...
                <h1 className="text-xl font-bold bg-gradient-to-r from-[#006d77] to-[#83c5be] bg-clip-text text-transparent">
                  AI Interview Coach
                </h1>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              <Link
                href="/"
                className="group flex items-center space-x-2 px-4 py-2 rounded-lg sm:rounded-xl md:rounded-2xlbg-gradient-to-r from-white/80 to-gray-50/80 backdrop-blur-sm border border-gray-200/50 hover:shadow-md transition-all duration-300 hover:scale-105"
              >
                <Home className="w-4 h-4 text-[#006d77]" />
                <span className="font-medium bg-gradient-to-r from-[#006d77] to-[#83c5be] bg-clip-text text-transparent">
                  Home
                </span>
              </Link>
              <button
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 p-4 hover:shadow-2xl transition-all duration-300">
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-lg font-bold bg-gradient-to-r from-[#006d77] to-[#83c5be] bg-clip-text text-transparent">
                  Coach Preview
                </h3>
              </div>
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-xl sm:rounded-2xl md:rounded-3xl shadow-xl border border-white/20 p-3 sm:p-4 md:p-6 hover:shadow-2xl transition-all duration-300">
              <h3 className="text-lg font-bold bg-gradient-to-r from-[#006d77] to-[#83c5be] bg-clip-text text-transparent mb-3 sm:mb-4 md:mb-6">
                Interview Performance
              </h3>
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 rounded-lg bg-gradient-to-r from-[#e29578]/20 to-[#ffddd2]/10 border border-[#e29578]/20">
                  <span className="text-sm font-semibold text-gray-700">Score</span>
                  <span className="text-lg font-bold bg-gradient-to-r from-[#006d77] to-[#83c5be] bg-clip-text text-transparent">
                    {lastAIResponse?.score !== undefined ? `${lastAIResponse.score}/10` : 'N/A'}
                  </span>
                </div>
                <div className="p-3 rounded-lg bg-gradient-to-r from-[#83c5be]/10 to-[#006d77]/5 border border-[#83c5be]/20">
                  <span className="block text-sm font-semibold text-gray-700 mb-1">Feedback</span>
                  <span className="text-sm text-gray-800">
                    {lastAIResponse?.feedback ? lastAIResponse.feedback : 'No feedback yet.'}
                  </span>
                </div>
              </div>
            </div>

            {/* Interview Tips (Hidden) */}
            {/*
            <div className="bg-white/80 backdrop-blur-xl rounded-xl sm:rounded-2xl md:rounded-3xl shadow-xl border border-white/20 p-3 sm:p-4 md:p-6 hover:shadow-2xl transition-all duration-300">
            ...
            */}
            ...
            <div className="lg:col-span-2">
              <div
                className="bg-white/80 backdrop-blur-xl rounded-xl sm:rounded-2xl md:rounded-3xl shadow-2xl border border-white/20 flex flex-col hover:shadow-3xl transition-all duration-300"
                style={{ height: "700px" }}
              >
                {/* Premium Chat Header */}
                <div className="flex items-center justify-between p-3 sm:p-4 md:p-6 border-b border-gray-100/50 bg-gradient-to-r from-white/90 to-gray-50/90 backdrop-blur-sm rounded-t-3xl">
                  <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm bg-gradient-to-r from-gray-600 to-gray-800 bg-clip-text text-transparent">
                ...
                <div className="flex-1 overflow-y-auto p-3 sm:p-4 md:p-6 space-y-6 bg-gradient-to-b from-[#edf6f9]/50 to-white/50">
                  {messages.map((message) => (
                    ...
                    >
                      ...
                      >
                        <div
                          className={`w-10 h-10 rounded-lg sm:rounded-xl md:rounded-2xlflex items-center justify-center flex-shrink-0 shadow-lg ${
                            message.type === "user"
                        ...
                        <div
                          className={`relative rounded-lg sm:rounded-xl md:rounded-2xlp-2 sm:p-3 md:p-4 shadow-sm border ${
                            message.type === "user"
                        ...
                        <div className="bg-white/90 backdrop-blur-sm rounded-lg sm:rounded-xl md:rounded-2xlp-2 sm:p-3 md:p-4 shadow-sm border border-gray-200/50">
                          <div className="flex items-center space-x-3">
                            ...
                            <div className="flex space-x-1">
                              ...
                              <div
                                className="w-2 h-2 bg-[#83c5be] rounded-full animate-bounce"
