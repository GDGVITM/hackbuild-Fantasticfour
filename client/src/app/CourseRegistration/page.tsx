...
export default function CourseRegistrationPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden" 
          ...
          <div className="mb-8">
            ...
            <div className="space-y-4">
              {dummyStudent.courses.map((course, index) => (
                <div key={course.code} 
                     className="flex items-center justify-between p-4 rounded-lg border-2 border-opacity-30 transition-all duration-300 hover:shadow-md hover:scale-[1.02]" 
                     style={{ 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6 w-full max-w-2xl z-10">
