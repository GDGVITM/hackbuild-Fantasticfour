...
//         {/* Large gradient orbs */}
//         <div className="absolute -top-2 sm:p-3 md:p-40 -right-40 w-96 h-96 rounded-full opacity-10 animate-pulse" 
//              style={{ 
...
//               <Link href="/" className="text-xl sm:text-2xl md:text-3xl font-bold tracking-tight flex items-center space-x-3 group" style={{ color: '#006d77' }}>
//                 <div className="w-12 h-12 rounded-lg sm:rounded-xl md:rounded-2xlflex items-center justify-center transition-all duration-300 group-hover:scale-110 shimmer-effect"
...
//         <div className={`rounded-xl sm:rounded-2xl md:rounded-3xl shadow-2xl p-4 sm:p-6 md:p-8 mb-8 backdrop-blur-lg card-hover relative overflow-hidden ${isLoaded ? 'animate-slideIn' : ''}`}
//              style={{ 
//                backgroundColor: 'rgba(255, 255, 255, 0.95)',
//                borderColor: 'rgba(131, 197, 190, 0.3)',
...
//               <div className="w-16 h-16 rounded-lg sm:rounded-xl md:rounded-2xlflex items-center justify-center shadow-xl shimmer-effect"
//                    style={{ background: 'linear-gradient(135deg, #83c5be, #006d77)' }}>
//                 <BookOpen className="w-8 h-8 text-white" />
//               </div>
//             </div>
//             <div className="flex-1">
//               <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 tracking-tight" style={{ color: '#006d77' }}>Interview Resources Hub</h2>
//               <p className="text-lg mb-3 sm:mb-4 md:mb-6 leading-relaxed" style={{ color: '#83c5be' }}>
...
//         <div className="rounded-xl sm:rounded-2xl md:rounded-3xl shadow-xl p-4 sm:p-6 md:p-8 mb-8 backdrop-blur-lg card-hover"
//              style={{ 
//                backgroundColor: 'rgba(255, 255, 255, 0.95)',
//                borderColor: 'rgba(131, 197, 190, 0.3)'
//              }}>
//           <div className="flex flex-col lg:flex-row gap-3 sm:p-4 md:p-6">
//             {/* Enhanced Search Bar */}
//             <div className="flex-1">
...
//                   className="w-full pl-12 pr-4 py-4 rounded-lg sm:rounded-xl md:rounded-2xltext-lg font-medium transition-all duration-300 focus:scale-105 focus:shadow-xl"
//                   style={{ 
...
//               className="lg:hidden flex items-center justify-center px-6 py-4 rounded-lg sm:rounded-xl md:rounded-2xltext-white font-bold transition-all duration-300 hover:scale-105 hover:shadow-xl"
...
//           {/* Enhanced Filters */}
//           <div className={`${showFilters ? 'block' : 'hidden'} lg:block mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:p-4 md:p-6`}>
//             {[
...
//         <div className="mb-8">
//           <div className="inline-flex items-center px-6 py-3 rounded-lg sm:rounded-xl md:rounded-2xlshadow-lg"
...
//         <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-2 sm:gap-3 md:gap-4 sm:p-6 md:p-8">
//           {filteredResources.map((resource, index) => (
//             <div key={resource.id} 
//                  className="rounded-xl sm:rounded-2xl md:rounded-3xl shadow-xl border backdrop-blur-lg card-hover relative overflow-hidden"
//                  style={{ 
//                    backgroundColor: 'rgba(255, 255, 255, 0.95)',
//                    borderColor: 'rgba(131, 197, 190, 0.3)',
...
//                   <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-4">
//                     <div className="p-3 rounded-lg sm:rounded-xl md:rounded-2xlshadow-lg shimmer-effect"
...
//                 <p className="text-base mb-3 sm:mb-4 md:mb-6 leading-relaxed line-clamp-3" style={{ color: '#83c5be' }}>
//                   {resource.description}
//                 </p>

//                 <div className="flex flex-wrap gap-3 mb-3 sm:mb-4 md:mb-6">
...
//                   className="w-full px-6 py-4 rounded-lg sm:rounded-xl md:rounded-2xltext-base font-bold text-white transition-all duration-300 hover:scale-105 hover:shadow-xl flex items-center justify-center space-x-3 shimmer-effect"
//                   style={{ backgroundColor: '#006d77' }}
//                 >
...
//             <div className="w-24 h-24 rounded-xl sm:rounded-2xl md:rounded-3xl flex items-center justify-center mx-auto mb-3 sm:mb-4 md:mb-6 shadow-xl shimmer-effect"
//                  style={{ background: 'linear-gradient(135deg, #83c5be, #006d77)' }}>
//               <Search className="w-12 h-12 text-white" />
//             </div>
//             <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-3" style={{ color: '#006d77' }}>No resources found</h3>
//             <p className="text-lg" style={{ color: '#83c5be' }}>Try adjusting your filters or search terms.</p>
//           </div>
//         )}

//         {/* Enhanced Quick Stats */}
//         <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-3 sm:p-4 md:p-6">
//           {[
//             {
...
//           ].map((stat, index) => (
//             <div key={index} 
//                  className="rounded-xl sm:rounded-2xl md:rounded-3xl shadow-xl p-3 sm:p-4 md:p-6 text-center card-hover backdrop-blur-lg relative overflow-hidden"
//                  style={{ 
//                    backgroundColor: 'rgba(255, 255, 255, 0.95)',
//                    borderColor: 'rgba(131, 197, 190, 0.3)',
...
//                 <div className="w-16 h-16 rounded-lg sm:rounded-xl md:rounded-2xlmx-auto mb-2 sm:mb-3 md:mb-4 flex items-center justify-center shadow-lg shimmer-effect"
...
//         <div className="mt-16 rounded-xl sm:rounded-2xl md:rounded-3xl shadow-2xl p-4 sm:p-6 md:p-8 backdrop-blur-lg card-hover relative overflow-hidden"
//              style={{ 
//                backgroundColor: 'rgba(255, 255, 255, 0.95)',
//                borderColor: 'rgba(131, 197, 190, 0.3)'
//              }}>
...
//             <div className="w-20 h-20 rounded-xl sm:rounded-2xl md:rounded-3xl mx-auto mb-3 sm:mb-4 md:mb-6 flex items-center justify-center shadow-xl shimmer-effect"
//                  style={{ background: 'linear-gradient(135deg, #006d77, #83c5be)' }}>
//               <Star className="w-10 h-10 text-white" />
//             </div>
//             <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2 sm:mb-3 md:mb-4" style={{ color: '#006d77' }}>
...
export default function InterviewResourcesPage() {
  ...
  const filterItems = [
    { key: 'category', label: 'Category', value: selectedCategory, setValue: setSelectedCategory, options: categories },
    { key: 'branch', label: 'Branch', value: selectedBranch, setValue: setSelectedBranch, options: branches },
    { key: 'difficulty', label: 'Difficulty', value: selectedDifficulty, setValue: setSelectedDifficulty, options: difficulties },
    { key: 'type', label: 'Type', value: selectedType, setValue: setSelectedType, options: types }
  ];
    ...
    <div className="min-h-screen bg-[#edf6f9] flex">
      ...
      `}>
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-white/10">
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 bg-[#83c5be] rounded-lg flex items-center justify-center">
              <Star className="w-4 h-4 text-[#006d77]" />
            </div>
        ...
        <div className="p-4 border-b border-white/10">
          <h2 className="text-lg font-bold text-white">Interview Resources</h2>
          <p className="text-xs text-white/70">All Engineering Branches</p>
        </div>

        {/* Filters */}
        <div className="p-4">
          <h3 className="text-sm font-semibold text-white/90 mb-4">Filters</h3>
            ...
            {filterItems.map((filter) => (
              <div key={filter.key}>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white text-sm focus:ring-2 focus:ring-[#83c5be] focus:border-[#83c5be]"
                >
                  {filter.options.map(option => (
          ...
          <div className="space-y-2">
            <div className="p-3 bg-white/10 rounded-xl">
              <div className="flex items-center gap-3 mb-2">
                <div className="w-6 h-6 rounded-lg flex items-center justify-center bg-[#83c5be]/40">
                  <Code className="w-3 h-3 text-[#83c5be]" />
                </div>
                <span className="font-medium text-white text-sm">DSA Resources</span>
              </div>
              <p className="text-lg font-bold text-[#ffddd2]">
                <AnimatedCounter end={resources.filter(r => r.category === 'DSA').length} />
              </p>
            </div>
            <div className="p-3 bg-white/10 rounded-xl">
              <div className="flex items-center gap-3 mb-2">
                <div className="w-6 h-6 rounded-lg flex items-center justify-center bg-[#e29578]/40">
                  <Wrench className="w-3 h-3 text-[#e29578]" />
                </div>
                <span className="font-medium text-white text-sm">Core Engineering</span>
              </div>
              <p className="text-lg font-bold text-[#ffddd2]">
                <AnimatedCounter end={resources.filter(r => r.category === 'Core Engineering').length} />
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
          ...
          <div className="px-4 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-lg font-bold text-[#006d77]">Resources Hub</h1>
                  <p className="text-xs text-[#83c5be]">Interview Preparation</p>
                </div>
              </div>

              {/* Actions */}
              <div className="flex items-center space-x-2">
                <div className="hidden sm:flex items-center bg-[#83c5be]/10 rounded-lg px-3 py-2">
        ...
        <main className="flex-1 overflow-auto p-4">
          {/* Search Bar */}
          <div className="bg-white rounded-2xl p-4 mb-6 border border-[#83c5be]/20">
            <div className="relative">
              <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#83c5be] w-5 h-5" />
              <input
                type="text"
                placeholder="Search resources..."
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                className="w-full pl-12 pr-4 py-3 border border-[#83c5be]/30 rounded-lg text-sm text-[#006d77] focus:ring-2 focus:ring-[#006d77] focus:border-[#006d77]"
              />
            </div>
          </div>
          ...
          <div className="mb-6 sm:hidden">
            <div className="bg-white rounded-lg p-3 border border-[#83c5be]/20">
              <p className="text-sm text-[#006d77]">
                Showing <span className="font-bold text-[#e29578]">{filteredResources.length}</span> resources
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-6 md:space-y-0">
            {filteredResources.map((resource, index) => (
              <div key={resource.id} 
                   className="bg-white rounded-2xl border border-[#83c5be]/20 overflow-hidden hover:shadow-lg transition-shadow duration-200">
                {/* Resource Header */}
                <div className="p-4 border-b border-[#edf6f9]">
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0"
                         style={{ backgroundColor: `${getDifficultyBg(resource.difficulty)}20` }}>
                      <div style={{ color: getDifficultyBg(resource.difficulty) }}>
                        {getCategoryIcon(resource.category)}
                      </div>
                    </div>
                    <div className="flex-1 min-w-0">
                      <h3 className="font-bold text-[#006d77] text-base line-clamp-2 leading-tight mb-1">
                        {resource.title}
                      </h3>
                      <div className="flex items-center gap-2">
                        <div className="w-4 h-4 flex items-center justify-center" style={{ color: COLORS.primaryLight }}>
                          {getBranchIcon(resource.branch[0])}
                        </div>
                        <span className="text-xs text-[#83c5be] font-medium truncate">
                          {resource.branch.join(', ')}
                        </span>
                      </div>
                    </div>
                ...
                {/* Resource Content */}
                <div className="p-4">
                  <p className="text-sm text-[#83c5be] mb-4 line-clamp-3">
                    {resource.description}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    <span className="px-2 py-1 rounded-lg text-xs font-medium text-white"
                          style={{ backgroundColor: getDifficultyBg(resource.difficulty) }}>
                      {resource.difficulty}
                    </span>
                    <span className="px-2 py-1 rounded-lg text-xs font-medium text-white"
                          style={{ backgroundColor: getTypeBg(resource.type) }}>
                      {resource.type}
                    </span>
                    <span className="px-2 py-1 rounded-lg text-xs font-medium text-[#006d77] bg-[#83c5be]/20">
                      {resource.category}
                    </span>
                  </div>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-[#006d77] text-white rounded-xl font-medium text-sm hover:bg-[#006d77]/90 transition-colors"
                  >
                    Access Resource
          ...
          {filteredResources.length === 0 && (
            <div className="text-center py-16">
              <div className="w-16 h-16 bg-gradient-to-br from-[#83c5be] to-[#006d77] rounded-2xl flex items-center justify-center mx-auto mb-4">
                <Search className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-lg font-bold text-[#006d77] mb-2">No resources found</h3>
              <p className="text-[#83c5be] mb-6">Try adjusting your filters or search terms.</p>
              <button
                onClick={() => {
          ...
          {/* Feature Highlight Section */}
          <div className="mt-12 bg-gradient-to-r from-[#006d77] to-[#83c5be] rounded-2xl p-8 text-center text-white">
            <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
              <Star className="w-8 h-8 text-white" />
            </div>
            <h3 className="text-xl font-bold mb-4">Curated by Industry Experts</h3>
            <p className="text-white/90 mb-6">
              All resources are carefully selected by professionals from top tech companies and engineering firms.
            </p>
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                <div className="text-2xl font-bold">
                  <AnimatedCounter end={resources.length} />+
                </div>
