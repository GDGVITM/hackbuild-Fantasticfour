...
//                 </div>
//                 <Link href="/" className="text-lg sm:text-xl md:text-2xl sm:text-xl sm:text-2xl md:text-3xl font-black text-white hover:text-[#ffddd2] transition-colors cursor-pointer">
//                   EduMitra
//                 </Link>
//               </div>
...
//         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:p-4 md:p-6 mb-12">
//           {[
//             {
//               title: 'Urgent',
...
//               <div 
//                 key={index}
//                 className={`group relative bg-white/98 backdrop-blur-2xl rounded-3xl p-3 sm:p-4 md:p-6 shadow-2xl border border-[#83c5be]/20 hover:shadow-3xl transition-all duration-700 hover:scale-105 hover:-translate-y-2 overflow-hidden`}
...
//                   <div className={`relative p-2 sm:p-3 md:p-4 ${stat.iconBg} rounded-2xl shadow-2xl group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 ${stat.pulse ? 'animate-pulse' : ''}`}>
...
//                     <p className={`text-xl sm:text-2xl md:text-3xl font-black ${stat.textColor} group-hover:scale-110 transition-transform duration-300`}>
//                       {stat.value}
//                     </p>
//                   </div>
//                 </div>
...
//         <div className="relative bg-white/98 backdrop-blur-2xl rounded-3xl shadow-2xl p-4 sm:p-6 md:p-8 mb-8 border border-[#83c5be]/20 overflow-hidden">
//           {/* Background decorations */}
//           <div className="absolute -top-2 sm:p-3 md:p-4 -right-4 w-16 h-16 bg-gradient-to-br from-[#ffddd2]/40 to-[#e29578]/20 rounded-full blur-2xl opacity-60"></div>
...
//             <div className={`${showFilters ? 'block' : 'hidden'} lg:block mt-8 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:p-4 md:p-6`}>
//               {/* Type Filter */}
//               <div className="group">
...
//             >
//               {/* Background decorations */}
//               <div className="absolute -top-3 sm:p-4 md:p-6 -right-6 w-20 h-20 bg-gradient-to-br from-[#ffddd2]/30 to-[#e29578]/15 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
...
//                       <div className="flex items-start gap-2 sm:p-3 md:p-4 mb-2 sm:mb-3 md:mb-4">
//                         <div className="flex-1">
//                           <div className="flex items-center gap-3 mb-3">
//                             <h3 className="text-lg sm:text-xl md:text-2xl font-black text-[#006d77] group-hover:text-[#83c5be] transition-colors duration-300">
//                               {announcement.title}
//                             </h3>
...
//                             )}
//                           </div>
//                           <p className="text-[#006d77]/80 text-lg leading-relaxed font-medium mb-2 sm:mb-3 md:mb-4">
...
//                 <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:p-4 md:p-6 mb-3 sm:mb-4 md:mb-6">
//                   <div className="flex items-center space-x-3 p-2 sm:p-3 md:p-4 bg-[#83c5be]/10 rounded-2xl border border-[#83c5be]/20">
...
//                     <div className="flex items-center space-x-3 p-2 sm:p-3 md:p-4 bg-[#e29578]/10 rounded-2xl border border-[#e29578]/20">
...
//                     <div className="flex items-center space-x-3 p-2 sm:p-3 md:p-4 bg-[#ffddd2]/30 rounded-2xl border border-[#ffddd2]/40">
...
//             {/* Background decorations */}
//             <div className="absolute -top-4 sm:p-6 md:p-8 -right-8 w-32 h-32 bg-gradient-to-br from-[#ffddd2]/20 to-[#e29578]/10 rounded-full blur-3xl"></div>
//             <div className="absolute -bottom-8 -left-8 w-24 h-24 bg-gradient-to-br from-[#83c5be]/20 to-[#006d77]/10 rounded-full blur-2xl"></div>
            
//             <div className="relative z-10">
//               <div className="w-24 h-24 bg-gradient-to-br from-[#ffddd2] to-[#e29578] rounded-3xl flex items-center justify-center mx-auto mb-3 sm:mb-4 md:mb-6 shadow-2xl">
//                 <Bell className="w-12 h-12 text-white" />
//               </div>
//               <h3 className="text-lg sm:text-xl md:text-2xl font-black text-[#006d77] mb-2 sm:mb-3 md:mb-4">No announcements found</h3>
...
//           <div className="absolute -top-4 sm:p-6 md:p-8 -right-8 w-32 h-32 bg-white/10 rounded-full blur-2xl animate-pulse"></div>
...
//             </p>
//             <div className="flex flex-wrap justify-center gap-3 sm:p-4 md:p-6 mb-8">
...
const mockAnnouncements: Announcement[] = [
  {
    id: '1',
    title: 'Google Software Engineer Intern 2025',
    description: 'Google is hiring software engineering interns for Summer 2025. Great opportunity for final year students with strong programming skills.',
    type: 'placement',
    date: new Date('2025-01-15'),
    deadline: new Date('2025-02-15'),
...
// Using your exact color palette
const typeColors = {
  placement: 'bg-[#006d77] text-white',
  course: 'bg-[#83c5be] text-[#006d77]',
  workshop: 'bg-[#e29578] text-white',
  exam: 'bg-[#ffddd2] text-[#006d77]',
  general: 'bg-[#006d77] text-white'
};
...
export default function AnnouncementsPage() {
  ...
  const filteredAnnouncements = mockAnnouncements.filter(announcement => {
    ...
    return matchesType && matchesSearch && announcement.isActive;
  });

  return (
    <div className="min-h-screen bg-[#edf6f9]">
      {/* Header with your color scheme */}
      <header className="bg-[#006d77] shadow-sm sticky top-0 z-50">
        <div className="px-4 py-4">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 bg-[#83c5be] rounded-lg flex items-center justify-center">
                <Bell className="w-4 h-4 text-[#006d77]" />
              </div>
            ...
            <Link
              href="/"
              className="flex items-center space-x-2 text-white/90 hover:text-white px-3 py-2 rounded-lg bg-white/10"
            >
      ...
      <div className="px-4 py-6 max-w-4xl mx-auto">
        ...
        {/* Search and Filters */}
        <div className="bg-white rounded-lg shadow-sm p-4 mb-6 border border-[#83c5be]/20">
          <div className="relative mb-4">
            ...
            <input
              ...
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
              className="w-full pl-10 pr-4 py-3 border border-[#83c5be]/30 rounded-lg focus:ring-2 focus:ring-[#006d77] focus:border-[#006d77] text-sm text-[#006d77]"
            />
          </div>

          <button
            onClick={() => setShowFilters(!showFilters)}
            className="w-full flex items-center justify-center px-4 py-2 bg-[#006d77] text-white rounded-lg font-medium hover:bg-[#006d77]/90"
          >
          ...
          {showFilters && (
            <div className="mt-4 pt-4 border-t border-[#83c5be]/20">
              ...
              <select
                value={selectedType}
                onChange={(e) => setSelectedType(e.target.value)}
                className="w-full px-3 py-2 border border-[#83c5be]/30 rounded-lg focus:ring-2 focus:ring-[#006d77] focus:border-[#006d77] text-sm text-[#006d77]"
              >
                <option value="all">All Types</option>
                <option value="placement">Placements</option>
                <option value="course">Courses</option>
        ...
        <div className="mb-6">
          <p className="text-sm text-[#006d77]">
            Showing <span className="font-semibold text-[#e29578]">{filteredAnnouncements.length}</span> announcements
          </p>
        </div>
        ...
        <div className="space-y-4">
          {filteredAnnouncements.map((announcement) => (
            <div 
              key={announcement.id} 
              className="bg-white rounded-lg shadow-sm border border-[#83c5be]/20 overflow-hidden hover:shadow-md transition-shadow duration-200"
            >
              <div className="p-4">
                {/* Header */}
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-start space-x-3 flex-1 min-w-0">
                    <div className={`w-10 h-10 ${typeColors[announcement.type]} rounded-lg flex items-center justify-center flex-shrink-0`}>
                      {getTypeIcon(announcement.type)}
                    </div>
                    
                    <div className="flex-1 min-w-0">
                      <h3 className="text-base font-semibold text-[#006d77] line-clamp-2 leading-tight mb-1">
                        {announcement.title}
                      </h3>
                      {announcement.company && (
                        <div className="flex items-center gap-1">
                          <Building className="w-3 h-3 text-[#83c5be]" />
                          <span className="text-xs font-medium text-[#83c5be]">
                            {announcement.company}
                          </span>
                        </div>
                      )}
                  ...
                  <div className={`px-2 py-1 rounded text-xs font-medium ${typeColors[announcement.type]} ml-2 flex-shrink-0`}>
                    {announcement.type.charAt(0).toUpperCase() + announcement.type.slice(1)}
                  </div>
                </div>

                {/* Description */}
                <p className="text-sm text-[#006d77]/70 mb-3 line-clamp-2">
                  {announcement.description}
                </p>

                {/* Details */}
                <div className="space-y-2 mb-4">
                  <div className="flex items-center text-xs text-[#83c5be]">
                    <Calendar className="w-3 h-3 mr-1" />
                    <span>Posted: {formatDate(announcement.date)}</span>
                  </div>
                  
                  {announcement.deadline && (
                    <div className="flex items-center text-xs text-[#e29578]">
                      <Calendar className="w-3 h-3 mr-1" />
                ...
                <div className="flex flex-wrap gap-1 mb-4">
                  {announcement.tags.slice(0, 3).map((tag, index) => (
                    <span 
                      key={index} 
                      className="inline-flex items-center px-2 py-1 bg-[#ffddd2] text-[#006d77] rounded text-xs font-medium"
                    >
                      #{tag}
                    </span>
                  ))}
                  {announcement.tags.length > 3 && (
                    <span className="text-xs text-[#83c5be] px-2 py-1">
                ...
                {/* Action */}
                <div className="flex items-center justify-between pt-3 border-t border-[#edf6f9]">
                  ...
                  {announcement.type === 'placement' && announcement.applicationLink ? (
                    <Link
                      href={announcement.applicationLink}
                      className="inline-flex items-center gap-1 px-4 py-2 bg-[#006d77] text-white text-xs font-medium rounded-lg hover:bg-[#006d77]/90 transition-colors"
                    >
                      Apply
                      <ArrowRight className="w-3 h-3" />
                    </Link>
                  ) : (
                    <button className="inline-flex items-center gap-1 px-4 py-2 bg-[#83c5be] text-[#006d77] text-xs font-medium rounded-lg hover:bg-[#83c5be]/90 transition-colors">
                      View
        ...
        {/* No Results */}
        {filteredAnnouncements.length === 0 && (
          <div className="bg-white rounded-lg shadow-sm p-8 text-center border border-[#83c5be]/20">
            <div className="w-12 h-12 bg-[#ffddd2] rounded-lg flex items-center justify-center mx-auto mb-4">
              <Bell className="w-6 h-6 text-[#e29578]" />
            </div>
            <h3 className="text-lg font-semibold text-[#006d77] mb-2">No announcements found</h3>
            <p className="text-[#83c5be] mb-4">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-[#006d77] text-white rounded-lg font-medium hover:bg-[#006d77]/90 transition-colors"
            >
              Reset Filters
            </button>
          </div>
        ...
        {/* Bottom CTA */}
        <div className="mt-12 bg-gradient-to-r from-[#006d77] to-[#83c5be] rounded-lg p-8 text-center">
          <h3 className="text-xl font-bold text-white mb-4">
            Never Miss an Opportunity
          </h3>
          <p className="text-white/90 mb-6">
            Get instant notifications for new placements and opportunities.
          </p>
          <button className="inline-flex items-center gap-2 px-6 py-3 bg-white text-[#006d77] rounded-lg font-medium hover:bg-white/90 transition-colors">
